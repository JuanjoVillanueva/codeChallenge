	$(function() {
		...
		var tinymce_options = {
				...
				// Theme options
				theme_advanced_buttons1 : "styleselect,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,forecolor,backcolor,|,sub,sup,|,fullscreen",
				theme_advanced_buttons2 : "cut,copy,pasteword,|,search,replace,|,bullist,numlist,|,undo,redo,|,link,unlink,image,cleanup,code",
				...
				*/
				...
				content_css : default_texteditor_path.replace('/grocery_crud/texteditor','') +"/css/content.css",
