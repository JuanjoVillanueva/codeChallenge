        ...
        <td <?php if ($unset_delete) { ?> style="border-left: none;"<?php } ?>
            <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>>
                <div class="only-desktops"  style="white-space: nowrap">
                    ...
                    <?php } ?>
                    <?php if(!$unset_clone){?>
                        <a class="btn btn-default" href='<?php echo $row->clone_url?>'><i class="fa fa-copy"></i> <?php echo $this->l('list_clone')?></a>
                    <?php }?>
                    <?php if (!$unset_delete) { ?>
                        <a data-target="<?php echo $row->delete_url?>" href="javascript:void(0)" title="<?php echo $this->l('list_delete')?>" class="btn btn-default delete-row">
                        ...
                        <?php if ($show_more_button) { ?>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if(!$unset_clone){?>
                                        <li>
                                            <a href='<?php echo $row->clone_url?>'><i class="fa fa-copy"></i> <?php echo $this->l('list_clone')?></a>
                                        </li>
                                    <?php }?>
                                    <?php if (!$unset_delete) { ?>
                                        <li>
                ...
                <div class="only-mobiles">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            ?>
                            <?php if(!$unset_clone){?>
                                <a href='<?php echo $row->clone_url?>'><?php echo $this->l('list_clone')?></a>
                            <?php }?>
                            <?php if (!$unset_read) { ?>
                                <li>
                                    <a href="<?php echo $row->read_url?>"><i class="fa fa-eye"></i> <?php echo $this->l('list_view')?></a>
