    ...
    <div class="gc-container">
        ...
        ?></div>
 		...
 		<div class="row">
                ...
                <div class="table-label">
                    ...
                    <div class="floatR t5">
                        ...
                        <?php if(!$unset_export) { ?>
                            ...
                            <a class="btn btn-default gc-export" data-url="<?php echo $export_url; ?>">
                                <i class="fa fa-cloud-download floatL t3"></i>
                                <div class="clear"></div>
                            </a>
                        <?php } ?>
                        <?php if(!$unset_print) { ?>
                            <a class="btn btn-default gc-print" data-url="<?php echo $print_url; ?>">
                                <i class="fa fa-print floatL t3"></i>
                                <div class="clear"></div>
                            </a>
                        <?php }?>

                        <div class="btn btn-default gc-full-width">
            ...
            <!-- Renta Multiple confirmation dialog -->
            <div class="renta-multiple-confirmation modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Renta</h4>
                        </div>
                        <div class="modal-body">
                            <p>¿estás seguro que quieres cambiar estos articulos a RENTA?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                <?php echo $this->l('form_cancel'); ?>
                            </button>
                            <button type="button" class="btn btn-danger renta-multiple-confirmation-button"
                                    data-target="<?php echo $renta_multiple_url; ?>">
                                Cambiar a RENTA
                            </button>
                        </div>
                    </div>
